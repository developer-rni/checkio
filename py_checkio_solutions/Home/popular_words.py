#!/home/nikita/github/checkio/venv/bin/checkio --domain=py run popular-words
...
# "one", "One", "oNe", "ONE" etc. will do.The search words are always indicated in the lowercase.If the word wasn’t
# found even once, it has to be returned in the dictionary with  0 (zero) value.Input:The text and the search words
# array.
# 
...
def popular_words(text: str, words: list) -> dict:
    ...
    result = {}
    for search_item in words:
        result[search_item] = text.count(search_item)
    return result
