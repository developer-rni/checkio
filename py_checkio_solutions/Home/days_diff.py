#!/home/nikita/github/checkio/venv/bin/checkio --domain=py run days-diff
...
# tomorrow = 1 day. The difference will always be either a positive number or zero, so don't forget about the
# absolute    value.
# 
