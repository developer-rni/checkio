#!/home/nikita/github/checkio/venv/bin/checkio --domain=py run sort-array-by-element-frequency
...
# Education byIlkka Kokkarinen
# 
# 
# END_DESC

def frequency_sort(items: list) -> iter:
